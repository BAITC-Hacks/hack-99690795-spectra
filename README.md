...
- переключатель интерфейса RU / ҚАЗ / EN с сохранением выбора;
- локализованные сообщения API, карточки и объяснения на русском, казахском и английском;
- телефонная компоновка с крупными touch-элементами и безопасными отступами экрана.
...
`language` — требуемый язык подрядчика, а `locale` — язык интерфейса и объяснения (`ru`, `kk` или `en`).
